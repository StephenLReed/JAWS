 ...
 * @author Brett Spell
 */
public class SynsetPointer implements Comparable<SynsetPointer>
{
  ...
  @Override
	public String toString()
	{
         ...
         * 
         * @param that the given synset pointer
         * @return +1 if the given synset pointer is greater than this one, 0 if equal, otherwise returns -1
         */
        public int compareTo(final SynsetPointer that) {
          int result = this.getType().compareTo(that.getType());
          if (result == 0) {
